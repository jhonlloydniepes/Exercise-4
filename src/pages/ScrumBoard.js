...
<button className=" w-80 h-32 shadow-2xl border border-gray-600 p-2 py-1 rounded-lg " onClick={changeMenu} value={true}>  +  </button>
                    ...
                    <button onClick={buttonProcced} type="w-[500px] h-96"
                     className="button w-32 mt-3 mr-4 shadow bg-orange-500 hover:bg-orange-400 focus:shadow-outline focus:outline-none">Add</button>  
                    <button onClick={buttonCancel} type="button" 
                    className="button w-32 bg-orange-500 hover:bg-orange-400 focus:shadow-outline focus:outline-none">Cancel</button>    
                        </center>  
                    )} 
